    ...
    <div id="about">
      ...
      <div id="about-us">
        ...
        <p>
          ...
          berdiri dari tanggal 1 September 2020 oleh Winson. Vetememes
          Production yang berdiri yang beralamat Windsor Phase 1 Blok II No.12
          Kecamatan Batam Kota, Batam. Perusahaan Vetememes Production ini
          sedang memproduksi short film misterius yang berjudul “The_Writer”
          dengan genre misterius/horror. Vetememes Production memperkerjakan
          dalam sebuah team yang terdapat lima orang yang terdiri dari Director,
          Scriptwritter, Editor and graphic, Marketing dan Cameraman/Video.
        </p>
      </div>
    </div>
  );
